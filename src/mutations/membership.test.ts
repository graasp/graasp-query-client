...
describe('Membership Mutations', () => {
  ...
  describe(
    buildTitleFromMutationKey(MUTATION_KEYS.POST_ITEM_MEMBERSHIP),
    () => {
  ...
  describe(
    buildTitleFromMutationKey(MUTATION_KEYS.EDIT_ITEM_MEMBERSHIP),
    () => {
  ...
  describe(
    buildTitleFromMutationKey(MUTATION_KEYS.DELETE_ITEM_MEMBERSHIP),
    () => {
  ...
  describe(buildTitleFromMutationKey(MUTATION_KEYS.SHARE_ITEM), () => {
