...
export const getTags = async ({ API_HOST }) => {
...
export const getItemTags = async (id, { API_HOST }) => {
...
export const deleteItemTag = async ({ id, tagId }, { API_HOST }) => {
  const res = await fetch(
